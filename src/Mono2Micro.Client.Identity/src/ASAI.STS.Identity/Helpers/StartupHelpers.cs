...
using ASAI.STS.Identity.Configuration;
using ASAI.STS.Identity.Configuration.ApplicationParts;
using ASAI.STS.Identity.Configuration.Constants;
using ASAI.STS.Identity.Configuration.Interfaces;
using ASAI.STS.Identity.Helpers.Localization;
using System.Linq;
...
namespace ASAI.STS.Identity.Helpers
{
